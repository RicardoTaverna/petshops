                ...
                <div class="row">
                    <!-- Detalhes do fornecedor -->
                        <%
                            ...
                            while(servico.next()){
                                servicoId = servico.getString("servicosId");
                        %>                    
                    <div class="col-8 jumbotron">
                        <h3>Adicionar Serviço</h3>

                        <form method="POST" action="EditarServicoController">
                            <input hidden name="servicosId" value="<%out.print(idS);%>" />
                            <div class="form-label-group mb-3">
                                <label for="inputNome" class="text-muted">Nome do Serviço</label>
                                <input type="text" id="inputNome" name="inputNome" class="form-control" placeholder="Nome do serviço" required value="<%out.print(servico.getString("nome"));%>" />
                            </div>
                            <div class="form-label-group mb-3">
                                <label for="inputDescricao" class="text-muted">Descrição</label>
                                <input type="text" id="inputDescricao" name="inputDescricao" class="form-control" placeholder="Descrição" required value="<%out.print(servico.getString("descricao"));%>" />
                            </div> 
                            <div class="form-label-group mb-3">
                                <label for="inputTempo" class="text-muted">Tempo do Serviço</label>
                                <input type="text" id="inputTempo" name="inputTempo" class="form-control" placeholder="Tempo do seviço em minutos" required value="<%out.print(servico.getString("tempo_servico"));%>" />
                            ...
                            <div class="form-label-group mb-3">
                                ...
                                <input type="text" id="inputPreco" name="inputPreco" class="form-control" placeholder="Preço" required value="<%out.print(servico.getString("preco"));%>" />
                            </div>
